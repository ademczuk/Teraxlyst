...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[teraxlyst: dropped output due to backpressure]\x1b[0m\r\n";
...
pub fn spawn(
    ...
    let reader_thread = thread::Builder::new()
        .name("teraxlyst-pty-reader".into())
        .spawn(move || {
    ...
    thread::Builder::new()
        .name("teraxlyst-pty-flusher".into())
        .spawn(move || loop {
    ...
    let done_e = done;
    thread::Builder::new()
        .name("teraxlyst-pty-waiter".into())
        .spawn(move || {
